...
CRITICAL RULE FOR QUANTITIES: If a row indicates multiple quantities of the same item (for example: "2 x 2530 = 5060" or "ItemA 2点 5060" or "ItemB ¥2,600 3点 ¥7,800"), you MUST split them into separate individual items in the JSON array based on the quantity. For example, if there are 3 of an item at 2,600 each, create 3 separate JSON objects using the EXACT printed name from the receipt: "<Original Name> (1 of 3)", "<Original Name> (2 of 3)", and "<Original Name> (3 of 3)", each with a price of 2600. DO NOT just list it once. DO NOT put the combined total. DO NOT use example names like Tendon or Lychee or ItemA; use the ACTUAL text from the receipt line.
